      ...
      <div className="min-h-screen flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600">Please wait while we verify your booking.</p>
          </CardContent>
        </Card>
      </div>
    );
      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-8 text-center">
          ...
          {paymentIntent && (
            <div className="text-left bg-gray-50 p-4 rounded-lg mb-6">
              <div className="text-sm space-y-1">
                ...
                <div><strong>Status:</strong> <span className="text-green-600 capitalize">{paymentIntent.status}</span></div>
              </div>
            </div>
          )}
          ...
          <div className="space-y-3">
            ...
            <Link href="/book-now">
              <Button variant="outline" className="w-full">Book Another Trip</Button>
            </Link>
          </div>
          
          <p className="text-sm text-gray-500 mt-4">
            Questions? Contact us at{" "}
            <a href="mailto:info@gonoblelane.com" className="text-amber-600 hover:underline">
