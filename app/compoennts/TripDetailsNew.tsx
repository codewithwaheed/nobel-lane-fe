              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className={`mt-1 w-full h-11 px-3 pr-10 border rounded-md appearance-none bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 ${
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                className={`mt-1 h-11 ${errors.date ? "border-red-500" : ""}`}
              />
              {errors.date && (
