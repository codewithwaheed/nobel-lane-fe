...
export const metadata: Metadata = {
  metadataBase: new URL("https://gonoblelane.com"),
    ...
    <html lang="en">
      <head>
        ...
        <link
          rel="preload"
          as="image"
          href="/images/noble-lane-executive-airport-transportF.webp"
        />

        <link rel="canonical" href="https://www.gonoblelane.com/" />

        <script type="application/ld+json" id="schema-placeholder">
          {}
        </script>
        <script
