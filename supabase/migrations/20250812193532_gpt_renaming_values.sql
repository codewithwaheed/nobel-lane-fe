...
drop policy if exists pricing_grid_read on public.pricing_grid;
drop policy if exists vehicle_types_read on public.vehicle_types;
drop policy if exists zones_read on public.zones;
drop policy if exists fees_read on public.additional_fees;

-- Create policies
create policy pricing_grid_read on public.pricing_grid
  for select using (true);
create policy vehicle_types_read on public.vehicle_types
  for select using (true);
create policy zones_read on public.zones
  for select using (true);
create policy fees_read on public.additional_fees
  for select using (true);